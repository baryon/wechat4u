...
var WechatCore = function () {
  ...
  (0, _createClass3.default)(WechatCore, [{
    ...
    value: function init() {
      ...
      return Promise.resolve().then(function () {
        ...
        return _this4.request({
          ...
          _this4.updateSyncKey(data.SyncKey);
    ...
    value: function sync() {
      ...
      return Promise.resolve().then(function () {
        ...
        return _this10.request({
          ...
          _this10.updateSyncKey(data['SyncKey']);
    ...
    key: 'updateSyncKey',
    value: function updateSyncKey(syncKey) {
    ...
    value: function uploadMedia(file) {
      ...
      return Promise.resolve().then(function () {
        ...
        if (_util.isStandardBrowserEnv) {
          ...
          name = _path2.default.basename(file.path);
          type = _mime2.default.lookup(name);
          var stat = _fs2.default.statSync(file.path);
          size = stat.size;
        ...
        form.append('id', 'WU_FILE_' + _this14.mediaSend++);
